...
def process_config(json_file, cluster=False):
    """
    Get the json file
    ...
    if cluster:
        ...
        config.summary_dir = os.path.join("/depot/qqiu/data/gaurav/DFKD/experiments", config.exp_name, "summaries/")
        config.checkpoint_dir = os.path.join("/depot/qqiu/data/gaurav/DFKD/experiments", config.exp_name, "checkpoints/")
        config.out_dir = os.path.join("/depot/qqiu/data/gaurav/DFKD/experiments", config.exp_name, "out/")
        config.log_dir = os.path.join("/depot/qqiu/data/gaurav/DFKD/experiments", config.exp_name, "logs/")
    ...
    logging.getLogger().info("Hi, This is Gaurav.")
