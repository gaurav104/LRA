...
class LeNet5HalfNorm(nn.Module):

    def __init__(self):
        super(LeNet5HalfNorm, self).__init__()

        self.conv1 = nn.utils.spectral_norm(nn.Conv2d(1, 3, kernel_size=(5, 5)))
        self.relu1 = nn.ReLU()
        self.maxpool1 = nn.MaxPool2d(kernel_size=(2, 2), stride=2)
        self.conv2 = nn.utils.spectral_norm(nn.Conv2d(3, 8, kernel_size=(5, 5)))
        self.relu2 = nn.ReLU()
        self.maxpool2 = nn.MaxPool2d(kernel_size=(2, 2), stride=2)
        self.conv3 = nn.utils.spectral_norm(nn.Conv2d(8, 60, kernel_size=(5, 5)))
        self.relu3 = nn.ReLU()
        self.fc1 = nn.Linear(60, 42)
        self.relu4 = nn.ReLU()
        self.fc2 = nn.Linear(42, 10)
